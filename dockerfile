...
#RUN java -jar esus.jar -console -continue
#RUN mv esus.jar /app/
RUN ls -ltr ; pwd
...
CMD ["java", "-jar", "esus.jar", "-url=localhost:5433/esus", "-username=postgres", "-password=esus", "-console", "-continue"]
#java -jar eSUS-AB-PEC-5.1.17-Linux64.jar -url=localhost:5433/esus -username=postgres -password=esus -console -continue
